    ...
    public partial class frmPOS : Form
    {
        ...
        private void AddItems(string id, string proID, string name, string cat, string price, Image pimage)
        {
            ...
            w.onSelect += (ss, ee) =>
            {
                ...
                //this line add new product, 새로운 아이템 클릭시
                // 첫 번째는 sr#, 두 번째는 0 from id
        ...
        private void GetTotal()
        {
            ...
            foreach (DataGridViewRow item in guna2DataGridView1.Rows)
            {
                ...
                //    double.Parse(item.Cells["dgvQty"].Value.ToString());
            }
            lblTotal.Text = tot.ToString("N2"); //N2가 소수점 자릿수까지 표시
        }
        ...
        private void btnDelivery_Click(object sender, EventArgs e)
        {
            ...
            if (frm.txtName.Text != "") //as take away did not gave driver info
            {
        ...
        private void btnKot_Click(object sender, EventArgs e)
        {
            ...
            if (MainID == 0)    //Insert
            {
                qry1 = @"Insert into tblMain Values(@aDate, @aTime, @TableName,
                        @WaiterName, @status, @orderType, @total, @received, @change, 
                            @driverID, @CustName, @CustPhone) Select SCOPE_IDENTITY()";
            ...
            // as we only saving data for kitchen value will update when payment received
